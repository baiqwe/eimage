...
export const messages = {
  ...
  pricing: {
    ...
    plans: {
      free: {
        name: 'Free',
        description: 'Try product image generation with starter credits',
        features: [
          '10 trial credits',
          'Main image and detail scene presets',
          'Prompt drafting workspace',
          '7-day generation history',
        ],
        limits: ['HD exports', 'Bulk generation', 'Priority queue'],
      },
      pro: {
        name: 'Pro',
        description: 'Monthly credits for active ecommerce sellers',
        features: [
          '500 monthly credits',
          'HD main and detail image exports',
          'Generation history and prompt reuse',
          'Batch task queue',
          'Commercial usage rights',
        ],
        limits: ['Team seats', 'Dedicated generation cluster'],
      },
      lifetime: {
        name: 'Lifetime',
        description: 'One-time access for studios and repeat launches',
        features: [
          'All Pro features',
          '2,000 launch credits included',
          'Extended asset history',
          'Reusable product projects',
          'Early access to API providers',
          'Priority support',
          'Lifetime updates',
        ],
        limits: [],
