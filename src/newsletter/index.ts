...
function getEnv(): NewsletterEnv {
  ...
  return {
    RESEND_API_KEY: typeof process !== 'undefined' ? process.env?.RESEND_API_KEY : undefined,
    BEEHIIV_API_KEY: typeof process !== 'undefined' ? process.env?.BEEHIIV_API_KEY : undefined,
    BEEHIIV_PUBLICATION_ID:
      typeof process !== 'undefined' ? process.env?.BEEHIIV_PUBLICATION_ID : undefined,
  }
}
  ...
  switch (config.provider) {
    ...
    case 'beehiiv': {
      ...
      if (!apiKey || !publicationId) {
        throw new Error('BEEHIIV_API_KEY and BEEHIIV_PUBLICATION_ID are required for newsletter.')
      }
